...
Avalues2M=SVCresult['SVC_'+date2M_name].fillna(0).to_list()
Avalues1M=SVCresult['SVC_'+date1M_name].fillna(0).to_list()
Avalues0M=SVCresult['SVC_'+date0M_name].fillna(0).to_list()
